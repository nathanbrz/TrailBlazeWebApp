...
const generateItinerary = async (start_location, end_location, duration, interest) => {
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4o-mini",
            messages: [
                { role: "system", content: "You are a North American road trip travel itinerary generator."},

                { role: "user", content: `I am going on a North American road trip. I am traveling from ${start_location} to ${end_location} over the course of ${duration} days. 
                        ...
                        properties: {
                            itinerary: {
                                ...
                                items: {
                                    ...
                                    required: ["day", "location", "stay", "hotel", "activities", "travel_time", "notes"]
                                }
                            }
                        },
                        required: ["itinerary"]
